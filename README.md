...
This repository documents my testing of [Automation Exercise](https://automationexercise.com/).

## Contents
- [Test plan and documentation](docs/)
- [Manual test cases and execution results](test-cases/)
